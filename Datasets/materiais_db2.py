...
MATERIAIS_SIMPLES = {
    ...
    "magnesio_az31":   (" magnésio (AZ31B)",          45000.0, 0.35, 1.77e-9, 1.02e9,  96.0, 26.0e-6),
...
MATERIAIS_COMPOSTOS = {
    "aco": {
        "aco_1020":     ("Aço carbono SAE/AISI 1020",     205000.0, 0.29, 7.87e-9, 4.86e8, 51.9, 11.7e-6),
        "aco_1045":     ("Aço carbono SAE/AISI 1045",     200000.0, 0.29, 7.85e-9, 4.86e8, 49.8, 11.6e-6),
        "aco_4140":     ("Aço liga SAE/AISI 4140 (Cr-Mo)", 205000.0, 0.29, 7.85e-9, 4.73e8, 42.6, 12.3e-6),
        "aco_316":      ("Aço inox AISI 316",              193000.0, 0.27, 8.00e-9, 5.00e8, 16.2, 16.0e-6),
        "aco_304":      ("Aço inox AISI 304",              193000.0, 0.27, 7.90e-9, 5.00e8, 16.2, 17.0e-6),
        "aco_s355":     ("Aço estrutural S355 (EN 10025)", 210000.0, 0.30, 7.85e-9, 4.86e8, 50.0, 12.0e-6),
        "aco_e335":     ("Aço mecanico Ck45 / E335 (DIN)", 210000.0, 0.30, 7.85e-9, 4.86e8, 47.0, 12.0e-6),
        "aco_maraging": ("Aço maraging 18Ni (alta resist.)", 190000.0, 0.30, 8.10e-9, 4.60e8, 25.0, 10.1e-6),
    },
    "ferro_fundido": {
    ...
    "titanio": {
        "ti_grau2":   ("Titânio Grau 2 (puro comercial)", 103000.0, 0.34, 4.51e-9, 5.23e8, 16.4, 8.6e-6),
        "ti_6al4v":   ("Titânio Ti-6Al-4V (Grau 5)",      113800.0, 0.34, 4.43e-9, 5.26e8,  6.7, 8.6e-6),
        "ti_beta21s": ("Titânio Beta 21S (alta resist.)", 100000.0, 0.33, 4.94e-9, 5.10e8,  7.8, 8.0e-6),
    },
    "aluminio_estrutural": {
...
MENU_NIVEL_1 = [
    ...
    ("ferro_fundido",       "Ferro fundido (varia MUITO -> sub-menu)",    "composto"),
