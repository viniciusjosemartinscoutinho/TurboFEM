...
def definir_secao() -> dict:
    ...
    print("1 - Perfil padrao: RETANGULAR (calcula A, Iy, Iz, J automaticamente)")
    print("2 - Perfil padrao: CIRCULAR CHEIO (calcula automaticamente)")
    print("3 - Perfil padrao: CIRCULAR TUBULAR (calcula automaticamente)")
    print("4 - Perfil padrao: PERFIL I (calcula automaticamente, aproximado)")
